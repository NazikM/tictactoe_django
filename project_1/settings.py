...
SECRET_KEY = 'django-insecure-sjj(3nr3+kpug)a8ajelxr=290s-qml&%pkb&y(ppy)ru7=f$n'
...
ASGI_APPLICATION = 'project_1.routing.application'
...
LOGIN_REDIRECT_URL = 'tictatoe/'
LOGOUT_REDIRECT_URL = 'tictatoe/'
